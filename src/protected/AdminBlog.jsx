  ...
  return (
    <div className="rte">
      <div className="rte-toolbar">
        ...
        <ToolBtn onClick={triggerImagePicker} disabled={uploading} title="Insert image">
          {uploading ? (
  ...
  return (
    <div>
      <div style={{ display: 'flex', gap: 8 }}>
        <input className="admin__input" value={value}
          onChange={e => onChange(e.target.value)}
          placeholder="https://... or upload below" />
        <button type="button" className="admin__btn admin__btn--ghost admin__btn--sm"
      ...
      {value && (
        <img src={value} alt="Cover preview" style={{ marginTop: 10, maxHeight: 120, borderRadius: 8, border: '1.5px solid var(--border)' }} />
      )}
    </div>
  )
}
  ...
  if (!session) return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .admin-login__error{background:rgba(220,38,38,0.08);border:1px solid rgba(220,38,38,0.2);border-radius:8px;padding:10px 14px;font-size:12px;color:#b91c1c;margin-bottom:14px;text-align:left}
        ...
        .admin-login__btn:hover:not(:disabled){opacity:0.9}
      ...
      <div className="admin-login">
        <div className="admin-login__card">
          ...
          <div className="admin-login__sub">Sign in with your admin account</div>
          {authError && <div className="admin-login__error">⚠ {authError}</div>}
          <form onSubmit={login}>
            <input className="admin-login__input" type="email"
              placeholder="Email" value={email}
              onChange={e => setEmail(e.target.value)}
              autoComplete="email" required autoFocus />
            <input className="admin-login__input" type="password"
              placeholder="Password" value={password}
              onChange={e => setPassword(e.target.value)}
              autoComplete="current-password" required />
            <button className="admin-login__btn" type="submit" disabled={authLoading}>
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .admin__btn--ghost:disabled{opacity:0.5;cursor:not-allowed}
              ...
              <div className="admin__form-card">
                <div className="admin__form-grid">
                  ...
                  <div className="admin__field admin__field--full">
                    ...
                    <CoverImageField value={form.cover_url} onChange={handleCoverChange} />
                  </div>
                  <div className="admin__field admin__field--full">
